...
public class FragUnVerifiedBuyer extends Fragment implements BuyerActivity.BuyerListener {
...
//    variables
    ...
    public void onResume() {
        ...
        getContactFromServer("", "Belum Akad Kredit");
    }
    ...
    public void onBuyerSearchChange(String buyer) {
        getContactFromServer(buyer, "Belum Akad Kredit");
    }
